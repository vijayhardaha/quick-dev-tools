...
export default function Meta({ meta }) {
	...
	return (
		<Head>
			...
			<link href="https://fonts.googleapis.com/css2?family=Courier+Prime:ital,wght@0,400;0,700;1,400;1,700&family=Federo&family=Poppins:ital,wght@0,400;0,500;0,600&display=swap" rel="stylesheet" />
		</Head>
	);
}
